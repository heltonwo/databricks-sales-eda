...
### Interactive dashboard built on Databricks SQL, powered by the **Silver** layer  of the Lakehouse (`sales_project_db.silver`), tracking sales performance, product catalog trends, and customer behavior.
